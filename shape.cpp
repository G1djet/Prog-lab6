...
bool Shape::isPointOnBoundary(int x, int y, double tolerance) {
    // Проверяем, находится ли точка на границе формы в пределах заданной погрешности
...
bool Shape::isTrapezoidRectangular() {
    // Проверяем, является ли форма прямоугольным трапецоидом
